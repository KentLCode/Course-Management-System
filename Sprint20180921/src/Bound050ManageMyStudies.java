// import what is required... here is an example
//import java.util.Scanner;
public class Bound050ManageMyStudies
{
////////////////////////////////////////////////////////////////////////////////
	/*--------------------------------------------------------------------------
	...
	//=========================================================================
		...
		/*
		*  Bound050ManageMyStudies()
		*/		 
		public Bound050ManageMyStudies()  
		{
			// This is the constructor for <<class name>>()
			// Allows access to the class methods.

		}// close Bound050ManageMyStudies() 	

 
		
		//=========================================================================
		// Define the methodDefineName() method
		/*
		*  ..()
		*   This methodDefineName() method ... 
		*	is a templated method..
		*  ...
		*/
		//public  methodDefineName() 
		{
			// insert code from here...
			//return userName;
		}// end methodDefineName()
