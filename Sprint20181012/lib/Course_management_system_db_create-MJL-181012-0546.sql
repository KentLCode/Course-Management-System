...
6. Database creation script updated by Mike Little, , 2018-10-06 22:41,
	The updates to this script are:
	6.1 there is a problem in the Role  enum("Admin", "Student", "coordinator", "Lecturer")
	    this is because this should be..
	    enum("administrator", "Student", "coordinator", "Lecturer")
7. Database creation script updated by Mike Little 2018-10-12 0550:
	7.1. Changed the PK of the Administrator table from AdminID to AdministratorID
	7.2. Changed the PK of the Coordinator   table from coordID to CoordinatorID
	7.3  No change to the PK of the Lecturer table.
	These changes made so that the administrator can update the relevant table.
...
AdministratorID  int(255) unsigned auto_increment Not Null Primary Key,
UserName   char(9) not null,
FirstName  varchar (40) not null,
LastName   varchar (40) not null,
Password char(40) not null,
...
insert into Administrator (AdministratorID, UserName, FirstName,LastName,Password,Email ) values
...
(
CoordinatorID  int(255) unsigned auto_increment Not Null Primary Key,
UserName   char(9) not null,
FirstName  varchar (40) not null,
LastName   varchar (40) not null,
Password char(40) not null,
...
insert into Coordinator (CoordinatorID, UserName, FirstName,LastName,Password,Email ) values
...
FirstName  varchar (40) not null,
LastName   varchar (40) not null,
Role  enum("administrator", "Student", "coordinator", "Lecturer"),
